...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="🎶 ᴍᴜsɪᴄ 🎶", callback_data="anu_"),
    ],
    [
...
def help_button(update, context):
    ...
    try:
        ...
        pass
@run_async
def anu_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "fallen_":
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(
            text=f"*ʜᴇʏ,*🥀\n  *ᴛʜɪs ɪs {BOT_NAME}*"
            "\n*ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ᴀɴᴅ ᴍᴜsɪᴄ ʙᴏᴛ ʙᴜɪʟᴛ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴇᴀꜱɪʟʏ ᴀɴᴅ ᴛᴏ ᴘʀᴏᴛᴇᴄᴛ ʏᴏᴜʀ ɢʀᴏᴜᴘ ꜰʀᴏᴍ ꜱᴄᴀᴍᴍᴇʀꜱ ᴀɴᴅ ꜱᴘᴀᴍᴍᴇʀꜱ.*"
            ...
            "\n────────────────────"
            "\n\n➲  ɪ ᴄᴀɴ ᴩʟᴀʏ ᴍᴜsɪᴄ ."
            f"\n\n➻ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ғᴏʀ ɢᴇᴛᴛɪɴɢ ʙᴀsɪᴄ ʜᴇʟᴩ{BOT_NAME}.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴀᴅᴍɪɴ", callback_data="Help_1"
                        ),
                        InlineKeyboardButton(
                            text="ᴀᴜᴛʜ", callback_data="Help_2"
                        ),
                        InlineKeyboardButton(
                            text="ʙʟᴀᴄᴋʟɪsᴛ", callback_data="Help_3"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="ʙʀᴏᴀᴅᴄᴀsᴛ", callback_data="Help_4"
                        ),
                        InlineKeyboardButton(
                            text="ᴇxᴛʀᴀs", callback_data="Help_5"
                        ),
                        InlineKeyboardButton(
                            text="ᴩʟᴀʏʟɪsᴛs", callback_data="Help_6"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="ᴩɪɴɢ", callback_data="Help_7"
                        ),
                        InlineKeyboardButton(
                            text="ᴩʟᴀʏ", callback_data="Help_8"
                        ),
                        InlineKeyboardButton(
                            text="sᴜᴅᴏ", callback_data="Help_9"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="ᴀᴄᴛɪᴠᴇ", callback_data="Help_10"
                        ),
                        InlineKeyboardButton(
                            text="sᴛᴀʀᴛ", callback_data="Help_11"
                        ),
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            text="🙄 ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅs" 
            ᴊᴜsᴛ ᴀᴅᴅ ɪɴ ᴛʜᴇ sᴛᴀʀᴛɪɴɢ ᴏғ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅs ᴛᴏ ᴜsᴇ ᴛʜᴇᴍ ғᴏʀ ᴄʜᴀɴɴᴇʟ.
...
/blacklistedchat : sʜᴏᴡs ᴛʜᴇ ʟɪsᴛ ᴏғ ʙʟᴀᴄᴋʟɪsᴛᴇᴅ ᴄʜᴀᴛs.
             **ʙʟᴏᴄᴋ ᴜsᴇʀs**
/block [ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ʀᴇᴩʟʏ ᴛᴏ ᴀ ᴄʜᴜᴛɪʏᴀ] : sᴛᴀʀᴛs ɪɢɴᴏʀɪɴɢ ᴛʜᴇ ᴄʜᴜᴛɪʏᴀ, sᴏ ᴛʜᴀᴛ ʜᴇ ᴄᴀɴᴛ ᴜsᴇ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs.
...
/play : sᴛᴀʀᴛs ᴩʟᴀʏɪɴɢ ғʀᴏᴍ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴩʟᴀʏʟɪsᴛ ᴏɴ sᴇʀᴠᴇʀ.,
    ...
    elif query.data == "Help_7":
        query.message.edit_text(
            text="*🍑 ᴩɪɴɢ ᴄᴏᴍᴍᴀɴᴅ*"
            ping : sʜᴏᴡ ᴛʜᴇ ᴩɪɴɢ ᴀɴᴅ sʏsᴛᴇᴍ sᴛᴀᴛs ᴏғ ᴛʜᴇ ʙᴏᴛ.
                 /stats : ɢᴇᴛ ᴛᴏᴩ 10 ᴛʀᴀᴄᴋ ɢʟᴏʙᴀʟ sᴛᴀᴛs, ᴛᴏᴩ 10 ᴜsᴇʀs ᴏғ ᴛʜᴇ ʙᴏᴛ,
                 ᴛᴏᴩ 10 ᴄʜᴀᴛs ᴏɴ ᴛʜᴇ ʙᴏᴛ, ᴛᴏᴩ 10 ᴩʟᴀʏᴇᴅ ɪɴ ᴛʜᴇ ᴄʜᴀᴛ ᴀɴᴅ ᴍᴀɴʏ ᴍᴏʀᴇ...,

            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup
        )
    elif query.data == "Help_8":
        query.message.edit_text(
            text="*💞 ᴩʟᴀʏ ᴄᴏᴍᴍᴀɴᴅs*"
...
/channelplay [ᴄʜᴀᴛ ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ɪᴅ] ᴏʀ [ᴅɪsᴀʙʟᴇ] : ᴄᴏɴɴᴇᴄᴛ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴀ ɢʀᴏᴜᴩ ᴀɴᴅ sᴛᴀʀᴛs sᴛʀᴇᴀᴍɪɴɢ ᴛʀᴀᴄᴋs ʙʏ ᴛʜᴇ ʜᴇʟᴩ ᴏғ ᴄᴏᴍᴍᴀɴᴅs sᴇɴᴛ ɪɴ ɢʀᴏᴜᴩ.,
    ...
    elif query.data == "Help_9":
        query.message.edit_text(
            text="*🥀 sᴜᴅᴏᴇʀs ᴀɴᴅ ᴏᴡɴᴇʀ ᴄᴏᴍᴍᴀɴᴅs *"
             **ᴀᴅᴅ & ʀᴇᴍᴏᴠᴇ sᴜᴅᴏᴇʀ**
...
/speedtest : ᴄʜᴇᴄᴋ ʙᴏᴛ sᴇʀᴠᴇʀ sᴩᴇᴇᴅ.
...
/authorized : sʜᴏᴡs ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀʟʟᴏᴡᴇᴅ ᴄʜᴀᴛs.,
    ...
    elif query.data == "Help_10":
        query.message.edit_text(
            text="*🤑 ᴀᴄᴛɪᴠᴇ ᴠɪᴅᴇᴏᴄʜᴀᴛs*"
...
/autoend [ᴇɴᴀʙʟᴇ|ᴅɪsᴀʙʟᴇ] : ᴇɴᴀʙʟᴇ sᴛʀᴇᴀᴍ ᴀᴜᴛᴏ ᴇɴᴅ ɪғ ɴᴏ ᴏɴᴇ ɪs ʟɪsᴛᴇɴɪɴɢ.,
    ...
    elif query.data == "Help_11":
        query.message.edit_text(
            text="*😅 ɢᴇᴛ sᴛᴀʀᴛᴇᴅ ᴡɪᴛʜ ʙᴏᴛ*"
            /anu : sᴛᴀʀᴛs ᴛʜᴇ ᴍᴜsɪᴄ ʙᴏᴛ.
/pui : ɢᴇᴛ ʜᴇʟᴩ ᴍᴇɴᴜ ᴡɪᴛʜ ᴇxᴩʟᴀɴᴀᴛɪᴏɴ ᴏғ ᴄᴏᴍᴍᴀɴᴅs.
...
{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ.
© 2022 - 2023 [@anu](https://t.me/{SUPPORT_CHAT}), ᴀʟʟ ʀɪɢʜᴛs ʀᴇsᴇʀᴠᴇᴅ.
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
