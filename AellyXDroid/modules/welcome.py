...
import AellyXDroid
import AellyXDroid.modules.sql.welcome_sql as sql
...
from AellyXDroid.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                creator = None
                if not AellyXDroid.ALLOW_CHATS:
